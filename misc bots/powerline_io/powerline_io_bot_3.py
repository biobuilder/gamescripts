...
LOOK_DISTANCE = 8
LOOK_MAX_DISTANCE = 25

# camera focus
REGION_W = int(LOOK_MAX_DISTANCE*2)
REGION_H = int(LOOK_MAX_DISTANCE*2)
...
PIXEL_WALL_LUMINANCE = 150      # must be greater than this to identify a wall
...
# randomization
RAND_DIR_CHANCE = 30 # chance of changing direction
...
prevDirection = UP # previous direction
...
def randomizeDirection( wallDetection ):
    for i in range(1,100,1):
        r = random.randint(0,3)
        if( wallDetection[r] == FALSE):
            return(getCharDirection(r))
...
print( decideDirection("UP", [0,1,2,3]) )   
